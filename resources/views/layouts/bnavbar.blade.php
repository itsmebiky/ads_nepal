@if(Auth::guest())
<nav class="navbar-expand-md navbar-inverse fixed-top bg-dark navbar-laravel">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @guest
                    ...
                    @endif
                @else
                <li class="nav-item dropdown"><a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                  Home</a></li>
...
@else
<nav class="navbar navbar-expand-md navbar-inverse fixed-top bg-dark navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            {{ config('app.name', 'Laravel') }}
        </a>
...
<li class="active">
        <button class="btn btn-primary adminnav my-1" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        Post<span><i class="fas fa-dropdown"></i></span>
        </button>
            <div class="collapse" id="collapseExample">
              <div>
            <a href="{{'/admin/backend/create'}}" class="text-justify my-1">Create Post</a>
            <a href="{{'/admin/backend/show'}}" class="text-justify my-1">View Posts</a>
              </div>
            </div> 
</li>
<li class="active">
