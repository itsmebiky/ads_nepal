...
<div class="unit-5 overlay" style="background-image: url('/bikash/images/hero_1.jpg');">
  <div class="container text-center">
    <h2 class="mb-0">Contact</h2>
    <p class="mb-0 unit-6"><a href="/">Home</a> <span>></span> <span>Contact</span></p>
  </div>
</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="p-4 mb-3 bg-white">
                        ...
                        <p class="mb-4">Kausaltar, Bhaktapur, Kathmandu</p>
          
                        <p class="mb-0 font-weight-bold">Phone</p>
                        <p class="mb-4"><a href="#">+977-984-365-900</a></p>
          
                        <p class="mb-0 font-weight-bold">Email Address</p>
                        <p class="mb-0"><a href="itsmebiky@gmail.com">AdsFinder</span></a></p>
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div>
                                ...
                                <p class="mb-0">Kausaltar - 2 <br>  10 Bhaktapur</p>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div>
                            ...
                            <div class="col-md-4">
                              ...
                              <p class="mb-0">Email: <a href="itsmebiky@gmail.com">AdsFinder</a> <br>
                              Phone: (+977) 98-436-59300 </p>
                            </div>
                          </div>
                        </div>
                      </div>
{{-- <div class="wrapper">
        ...
        <div id="content" >
            ...
            <div class="container" id="bgcontact">
                  <br><br>
                ...
                <div class="row" id="contactt">
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="form-group">               
                                        ...
                                        <div class="input-group">
                                              <i class="fas fa-user"></i>
                                            <input type="text" class="form-control" placeholder="Enter Your Middle name" name="FirstName" >
                                          </div>  
                                </div>  
                          </div>
                ...
                <div class="row" id="contactt">
                    ...
                    <div class="form-group">               
                                  ...
                                  <input type="text" class="form-control" placeholder="Enter your email" name="EmailAddress" required>
                                    </div>
                    </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <textarea class="form-control" name="Comments" rows="5" style="width:98%" placeholder="Enter your message here"></textarea>
